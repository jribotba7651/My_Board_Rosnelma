...
class UpdateStoryBoardView extends StatelessWidget {
  const UpdateStoryBoardView({super.key});

  @override
  Widget build(BuildContext context) {
    var controller = Get.find<StoryBoardController>();
            ...
            child: Column(
              children: [
                ...
                TextFormField(
                  ...
                  onChanged: (value) {
                    controller.selectedStory.title = value;
                  },
                ...
                TextFormField(
                  ...
                  validator: FormValidatorConstant.commonValidator,
                    onChanged: (value) {
                    controller.selectedStory.description = value;
                  },
                  maxLines: 8,
                  maxLength: 400,
                  ...
                  child: GetBuilder<StoryBoardController>(builder: (cont) {
                    return SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemCount: controller.selectedStory.image!.length,
                          ...
                          return Stack(
                            children: [
                              Container(
                                ...
                                child: Image.network(
                                  controller.selectedStory.image![index],
                                  fit: BoxFit.cover,
                              ...
                              Positioned(
                                ...
                                left: Get.width / 2,
                                child: Text(
                                  '${index + 1}/${controller.selectedStory.image!.length}',
                                  style: TextStyle(
